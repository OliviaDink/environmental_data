...
In this section you find instructions on how to create a scatterplot. Use the ~ sign to plot the y against the x variable. Remember that the y variable will be stated first, the x variable comes after the tilde sign. The pch argument will determine the shape of the data points, the col argument will color the different sites in the plot, and the cex argument determines the size of the data points. Use the main, xlab and ylab argument to give a title name the axes. Use xlim and ylim to determine the size of the x and y axis.
```{r}
...
In the following you can see a code for a histogram. The breaks argument will detemrmine how many columns you have in the plot representing your data.
```{r}
